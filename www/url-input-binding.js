// REPREX: Used to track whether this file is loaded via shinytest
...
$.extend(urlInputBinding, {
  ...
  find: function(scope) {
    // REPREX: Using spread notation, which PhantomJS might not like
    //   See https://github.com/ariya/phantomjs/issues/15187
    Math.max(...[0, 1, 2]);
